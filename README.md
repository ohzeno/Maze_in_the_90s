...
| 배포서버     | ![]()https://img.shields.io/badge/AWS-EC2-orange)                                                                                                                                                              |                    |
| DB       | 뱃지 찾는 중,,                                                                                                                                                                                                      | ㅇㅇfirebase, photon |
...
| 팀원   | 역할      | 비고                              | 깃헙                                 |
| ---- | ------- | ------------------------------- | ---------------------------------- |
| 오제노  | 팀장, 백엔드 | 통신 연구..!                        | https://github.com/ohzeno          |
...
| 박준영  | 프론트엔드   | 풀스택이쥬                           | https://github.com/JUNYOUNG31      |

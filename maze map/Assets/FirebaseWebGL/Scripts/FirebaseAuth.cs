...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseAuth
    {
        ...
        public static extern void CreateUserWithEmailAndPassword(string username, string email, string password, string objectName, string callback, string fallback);
